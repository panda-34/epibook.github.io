# Reconstruct_binary_tree_post_in_orders.cpp 07f410e6c098209e8b1ba1cc7cdd1ec09f45e485
import sys
import random
...
def reconstruct_post_in_orders(post_order, in_order):
    ...
    return reconstruct_post_in_orders_helper(post_order, 0, len(post_order),
                                             0, len(in_order), in_entry_idx_map)


def reconstruct_post_in_orders_helper(post_order, post_s, post_e,
                                      in_s, in_e, in_entry_idx_map):
    if post_e > post_s and in_e > in_s:
        ...
        return BinaryTreeNode(
            ...
            reconstruct_post_in_orders_helper(
                post_order, post_s, post_s + left_tree_size,
                in_s, idx, in_entry_idx_map),
            # Recursively builds the right subtree.
            reconstruct_post_in_orders_helper(
                post_order, post_s + left_tree_size, post_e - 1,
