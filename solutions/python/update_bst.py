# Update_BST.cc bd9b3e8c6bc4755e176bbf01d16d2a77b2bf5147
...
def main():
    ...
    assert BST.erase(7) is True
    assert BST.erase(9) is True
    # should output 8
    assert BST.get_root_val() == 8
    print(BST.get_root_val())
    assert BST.erase(4) is True
    # should output 8
    assert BST.get_root_val() == 8
    print(BST.get_root_val())
    assert BST.erase(8) is True
    # should output 5
    assert BST.get_root_val() == 5
    print(BST.get_root_val())
    assert BST.erase(5) is True
    assert BST.erase(3) is True
    # should output 2
    assert BST.get_root_val() == 2
    print(BST.get_root_val())
    assert BST.erase(2) is True
    assert BST.erase(1) is False
    assert BST.empty() is True
