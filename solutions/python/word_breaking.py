# Word_breaking.cc bd9b3e8c6bc4755e176bbf01d16d2a77b2bf5147
import sys
import random
import string
...
def decompose_into_dictionary_words(domain, dictionary):
    ...
    # domain[0 : i + 1] has a valid decomposition, and the length of the
    ...
    for i in range(len(domain)):
        ...
        # If last_length[i] = -1 look for j < i such that domain[0 : j + 1]
        # has a valid decomposition and domain[j + 1 : i + 1] is a
