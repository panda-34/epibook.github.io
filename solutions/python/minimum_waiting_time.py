# Minimum_waiting_time.cc bd9b3e8c6bc4755e176bbf01d16d2a77b2bf5147
import sys
import random
...
def minimum_total_waiting_time_pythonic(service_times):
    # Sort the service times in increasing order.
    service_times.sort()
    total_waiting_time = sum(remaining_queries * time for remaining_queries, time in
                             enumerate(reversed(service_times)))
    return total_waiting_time
