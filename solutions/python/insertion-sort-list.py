...
def insertion_sort(L):
    ...
    # The sublist consisting of nodes up to and including iter is sorted in increasing order. We need to ensure that after we move to L.next this property continues to hold. We do this by swapping L.next with its predecessors in the list till it's in the right place.
    while L and L.next:
