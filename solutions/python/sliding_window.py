...
from queue_with_max_using_deque import Queue
...
def main():
    w = 3
    A = [TrafficElement(0, 1.3), TrafficElement(2, 2.5),
    ...
    golden = [TrafficElement(0, 1.3), TrafficElement(2, 2.5),
