# Find_kth_element_in_two_sorted_arrays.cc bd9b3e8c6bc4755e176bbf01d16d2a77b2bf5147
import sys
import random
...
def main():
    ...
    for _ in range(10000):
        ...
        A = sorted(random.randrange(100000) for i in range(n))
        B = sorted(random.randrange(100000) for i in range(m))
