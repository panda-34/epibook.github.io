# Descendant_and_ancestor.cc bd9b3e8c6bc4755e176bbf01d16d2a77b2bf5147
...
def pair_includes_ancestor_and_descendant_of_m(possible_anc_or_desc_0,
    ...
    while (search_0 is not possible_anc_or_desc_1 and
           ...
           search_1 is not middle and (search_0 or search_1)):
        if search_0:
    ...
    return search_target(middle, possible_anc_or_desc_1 if search_0 is middle else
...
def small_test():
    ...
    assert pair_includes_ancestor_and_descendant_of_m(root, root.right.left.right.left.right,
                                                      root.right.left)
...
def main():
    ...
    assert pair_includes_ancestor_and_descendant_of_m(root, root.right.right, root.right)
    assert pair_includes_ancestor_and_descendant_of_m(root.right.right, root, root.right)
    assert not pair_includes_ancestor_and_descendant_of_m(root, root.right, root.right.right)
    assert not pair_includes_ancestor_and_descendant_of_m(root.right, root, root.right.right)
    assert (not pair_includes_ancestor_and_descendant_of_m(root.right.left, root.right.right,
                                                           root.right))
    assert (not pair_includes_ancestor_and_descendant_of_m(root.right.left, root.left.left,
                                                           root.right))
